...
// SWITCH2,  STM32 input - no more available on LimiFrog0.2
...
/*  ==== USART 2  ======================================================= */
  ...
  // USART2 available on extension port, through CONN_POS2/3/4_PIN 
...
// interrupt INT1_ACC_GYR  to STM32
...
#else
  #define	CONN_POS1_PIN		GPIO_PIN_0
  #define 	CONN_POS1_PORT		GPIOB
...
// Position 11
  ...
  // Position 11 = GND
#else
  #define	CONN_POS11_PIN		GPIO_PIN_9
  #define 	CONN_POS11_PORT		GPIOB
#endif
