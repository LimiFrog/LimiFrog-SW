...
// NOTE:
//  USB pin inits (DP, DM, VBUS_SENSE=) done at start-up 
// in LBF_Fixed_Inits() calling USB_IOcfg()

  
  /* Enable power to USB peripheral (now separate domain) */
  HAL_PWREx_EnableVddUSB();


  /* Enable USB Clock */
   __HAL_RCC_USB_OTG_FS_CLK_ENABLE();  //changed for L4 vs L1

  
  /* Enable SYSCFG Clock: already done in Inits elsewhere */
...
/** @brief EXTI line detection callbacks
  ...
  * @retval None
  */
// SPECIFIC TO ST's DEMO BOARD, NOT USED W/ LIMIFROG
/*
...
/*******  BELOW FUNCTIONS WERE USED IN L1 CUBE USB LIB
          as a replacement of malloc/free through adequate defines
 NO longer done in L4 USB lib but looks like it was a good idea 
  so revert to that :
*******/
...
// PRESENT IN L1 CUBE USB LIB,
// no more present in L4 USB lib?
