...
Reset_Handler:
/* Other linker files add here :
	ldr	sp, =_estack
   to set stack pointer -- redundant ? */
...
/* Following section updated to handle all interrupt sources */
g_pfnVectors:
	.word	_estack
	.word	Reset_Handler
	.word	NMI_Handler
	...
	.word	TSC_IRQHandler
	.word	LCD_IRQHandler
	.word	AES_IRQHandler  /*Was: 0 - No AES_IRQHandler in ST-proposed template - Why? */
	.word	RNG_IRQHandler
	.word	FPU_IRQHandler
...
/* Following section updated to handle all interrupt sources */
 ...
 /* Added as no AES_IRQHandler in ST-proposed template - Why? */
	.weak	AES_IRQHandler
