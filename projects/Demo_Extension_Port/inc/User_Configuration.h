...
//TODO Also cope with CAN_TX 
    ...
    // --------------------------
    #define 	EXT_PORT_POS10_Function  	EXTI9_5 
	// Valid Values = 
	//	NONE 
	//	GPIO
        //      EXTI9_5
...
//TODO Also cope with CAN_RX 
    ...
    #define 	EXT_PORT_POS10_GPIOtype  	IN_PD
    ...
    // --------------------------
    #define 	EXT_PORT_POS8_Function  	UART4_TX
    	// Valid Values = 
	//	NONE 
	//	GPIO
	//	EXTI0
    ...
    // --------------------------
    #define 	EXT_PORT_POS7_Function  	UART4_RX 
	// Valid Values = 
	//	NONE 
	//	GPIO
	//	EXTI1
    ...
    // --------------------------
    #define 	EXT_PORT_POS5_Function  	SPI_MOSI   
	// Valid Values = 
	//	NONE 
	//	GPIO
	//	EXTI2
    ...
    // --------------------------
    #define 	EXT_PORT_POS4_Function  	SPI_MISO  
	// Valid Values = 
	//	NONE 
	//	GPIO
	//	EXTI3
    ...
    // --------------------------
    #define 	EXT_PORT_POS3_Function  	SPI_CK
	// Valid Values = 
	//	NONE 
	//	GPIO
	//	EXTI4
...
//TODO also cope with DAC1_OUT
    ...
    //
    #define 	EXT_PORT_POS2_Function  	PWM_TIM16_CH1 
	// Valid Values = 
	//	NONE 
	//	GPIO
	//	EXTI9_5
