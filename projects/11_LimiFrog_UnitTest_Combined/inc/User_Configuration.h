...
// ============================================================================
    ...
    ******************************************************************/
    ...
    // --------------------------
    #define 	EXT_PORT_POS11_Function  	GPIO  
	// Valid Values = 
	//	NONE 
	//	GPIO
        //      EXTI9_5
...
//TODO Also cope with CAN_TX 
    ...
    #define 	EXT_PORT_POS11_GPIOtype		OUT
    ...
    // --------------------------
    #define 	EXT_PORT_POS10_Function  	GPIO 
	// Valid Values = 
	//	NONE 
	//	GPIO
        //      EXTI9_5
...
//TODO Also cope with CAN_RX 
    ...
    #define 	EXT_PORT_POS10_GPIOtype  	OUT
    ...
    // --------------------------
    #define 	EXT_PORT_POS8_Function  	GPIO
    	// Valid Values = 
	//	NONE 
	//	GPIO
	//	EXTI0
    ...
    #define 	EXT_PORT_POS8_GPIOtype  	OUT
	// Valid values (only apply to GPIO and partly to EXTI)
	// NA/IN/IN_PU/IN_PD/OUT/OUT_OD
    ...
    // --------------------------
    #define 	EXT_PORT_POS7_Function  	GPIO 
	// Valid Values = 
	//	NONE 
	//	GPIO
	//	EXTI1
    ...
    #define 	EXT_PORT_POS7_GPIOtype  	OUT 
	// Valid values (only apply to GPIO and partly to EXTI)
	// NA/IN/IN_PU/IN_PD/OUT/OUT_OD
    ...
    // --------------------------
    #define 	EXT_PORT_POS6_Function  	VCC_LDO
	// Valid Values = 
	//	NONE 
    ...
    // --------------------------
    #define 	EXT_PORT_POS5_Function  	GPIO   
	// Valid Values = 
	//	NONE 
	//	GPIO
	//	EXTI2
    ...
    #define 	EXT_PORT_POS5_GPIOtype  	OUT 
	// Valid values (only apply to GPIO and partly to EXTI)
	// NA/IN/IN_PU/IN_PD/OUT/OUT_OD
    ...
    // --------------------------
    #define 	EXT_PORT_POS4_Function  	GPIO  
	// Valid Values = 
	//	NONE 
	//	GPIO
	//	EXTI3
    ...
    #define 	EXT_PORT_POS4_GPIOtype  	OUT
	// Valid values (only apply to GPIO and partly to EXTI)
	// NA/IN/IN_PU/IN_PD/OUT/OUT_OD
    ...
    // --------------------------
    #define 	EXT_PORT_POS3_Function  	GPIO
	// Valid Values = 
	//	NONE 
	//	GPIO
	//	EXTI4
...
//TODO also cope with DAC1_OUT
    ...
    #define 	EXT_PORT_POS3_GPIOtype  	OUT
	// Valid values (only apply to GPIO and partly to EXTI)
	// NA/IN/IN_PU/IN_PD/OUT/OUT_OD
    ...
    //
    #define 	EXT_PORT_POS2_Function  	GPIO 
	// Valid Values = 
	//	NONE 
	//	GPIO
	//	EXTI9_5
    ...
    #define 	EXT_PORT_POS2_GPIOtype  	OUT
	// Valid values (only apply to GPIO and partly to EXTI)
	// NA/IN/IN_PU/IN_PD/OUT/OUT_OD
